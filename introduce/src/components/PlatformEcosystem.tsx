...
const ECOSYSTEM_FEATURES = [
  {
    ...
    desc: '全链路记录每次节点调用、耗时与 Token，便于回溯排错与合规审计。',
  },
  {
    id: 'collab',
    title: '多人协作（Alpha）',
    ...
    desc: '同一条 DAG 支持多人评论、段落锁定与异步合并，适合小组共创。',
  },
  {
    id: 'custom',
    title: '自定义节点',
    ...
    desc: '使用 Python 或 JavaScript 扩展业务逻辑，对接私有数据源与内部 API。',
  },
  {
    id: 'publish',
    title: '发布与 Fork',
    ...
    desc: '将成品工作流发布到市场，他人可一键 Fork 后本地化改造与再分发。',
  },
  {
    id: 'kg',
    title: '知识图谱增强',
    ...
    desc: '在检索结果中挂载实体与关系，强化 RAG 可追溯性与引用透明度。',
  },
];
      ...
      <div style={{ maxWidth: 1280, margin: '0 auto', padding: '0 32px' }}>
        ...
        <div className="reveal" style={{ marginBottom: 64, textAlign: 'center' }}>
          ...
          <h2 style={{
            ...
            不止是画布
            <br />
            <span className="marker-highlight" style={{ fontSize: 'clamp(32px, 4.5vw, 48px)' }}>更是可运营的学习基础设施</span>
          </h2>
          <p style={{ fontSize: 18, color: 'var(--text-secondary)', maxWidth: 640, margin: '0 auto', lineHeight: 1.6 }}>
            日志、协作、扩展与分发能力齐备，让 StudySolo 既能个人深度工作，也能小组共创。
          </p>
        </div>
