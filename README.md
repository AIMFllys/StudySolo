...
> 这不是 PPT 愿景，而是跟着 GitHub Milestone 推进的执行路径；可与答辩路线图页逐项对照。

### 近 2 个月（2026 Q4-Q5）

- MCP 协议从「开发中」走向「稳定可用」
- 外部 API 对接工程化（接入规范、鉴权策略、可观测性）
- 社区节点内容审核机制 + 安全沙箱落地
- 用户自有 API Key 的更好支持（配置、校验与治理）

### 6 个月（2026）

- 更多子智能体与对应工作流节点落地
- Wiki 官方文档站正式上线
- Agent Gateway 统一内部服务调用
- Prompt 工程化：节点级 A/B + 质量评分闭环
