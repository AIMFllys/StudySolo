...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="curl" key="MOVSW9o7tz"><RenderMd content={`\`\`\`Bash
...
<Tabs.TabPane title="Python SDK" key="ZbAq5YWLJl"><RenderMd content={`\`\`\`Python
import os
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java SDK" key="dxh5L53aeh"><RenderMd content={`\`\`\`Java
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go SDK" key="ENwxjWGqvK"><RenderMd content={`\`\`\`Go
package main
