...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Curl" key="rMvtWb7Mnp"><RenderMd content={`1. 上传PDF文件获取File ID。
   \`\`\`Bash
...
<Tabs.TabPane title="Python" key="pMxrVsM8TF"><RenderMd content={`\`\`\`Python
import asyncio
import os
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="hM2mfW4UQJ"><RenderMd content={`\`\`\`Go
package main
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="zD3sLAqYgC"><RenderMd content={`\`\`\`Java
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="OpenAI SDK" key="xsNPd3oGJX"><RenderMd content={`\`\`\`Python
import os
import time
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Curl" key="Ay3VqqLMYj"><RenderMd content={`\`\`\`Bash
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Python" key="RIolggBnwj"><RenderMd content={`\`\`\`Python
import os
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="x54Wg576Oj"><RenderMd content={`\`\`\`Go
package main
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="qtbmhXdX12"><RenderMd content={`\`\`\`Java
package com.ark.sample;
import com.volcengine.ark.runtime.model.responses.content.InputContentItemFile;
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="OpenAI SDK" key="myvUZqYqee"><RenderMd content={`\`\`\`Python
import os
from openai import OpenAI
import base64
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Curl" key="gmVd8IUc4v"><RenderMd content={`\`\`\`Bash
curl https://ark.cn-beijing.volces.com/api/v3/responses \\
-H "Authorization: Bearer $ARK_API_KEY" \\
-H 'Content-Type: application/json' \\
-d '{
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Python" key="o8vJFGBKfh"><RenderMd content={`\`\`\`Python
import os
from volcenginesdkarkruntime import Ark
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="FKIAawujbn"><RenderMd content={`\`\`\`Go
package main
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="qlYsxNXnN2"><RenderMd content={`\`\`\`Java
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="OpenAI SDK" key="EWtgHcLmbh"><RenderMd content={`\`\`\`Python
import os
from openai import OpenAI
...
```mixin-react
return (<Tabs>
<Tabs.TabPane title="Python" key="Fo4KeXSSCP"><RenderMd content={`\`\`\`Python
import asyncio
import os
from volcenginesdkarkruntime import AsyncArk
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Go" key="SibPnVc7Jt"><RenderMd content={`\`\`\`Go
package main
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="Java" key="B9rSw8VtFm"><RenderMd content={`\`\`\`Java
package com.ark.sample;
...
`}></RenderMd></Tabs.TabPane>
<Tabs.TabPane title="OpenAI SDK" key="lAUmiyFK6c"><RenderMd content={`\`\`\`Python
import os
import time
from openai import OpenAI
