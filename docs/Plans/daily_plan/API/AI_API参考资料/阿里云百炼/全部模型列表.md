...
| **旗舰模型** | ![new](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/4297966571/p838707.png) **千问Max** 适合复杂任务，能力最强 | ![new](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/4297966571/p838707.png) **千问Plus** 效果、速度、成本均衡 | ![new](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/4297966571/p838707.png) **千问Flash** 适合简单任务，速度快、成本低 | ![new](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/4297966571/p838707.png) **千问Coder** 卓越的代码模型，擅长工具调用和环境交互 |
| --- | --- | --- | --- | --- |
| 最大上下文长度 （Token数） | 262,144 | 1,000,000 | 1,000,000 | 1,000,000 |
| 最低输入价格 （每百万 Token） | 2.5元 | 0.8元 | 0.15元 | 1元  |
| 最低输出价格 （每百万 Token） | 10元 | 2元  | 1.5元 | 4元  |

## 全球

在[全球部署模式](https://help.aliyun.com/zh/model-studio/regions/#080da663a75xh)下，接入点与数据存储均位于**美国（弗吉尼亚）地域**，模型推理计算资源在全球范围内动态调度。

| **旗舰模型** | ![new](https://help-static-aliyun-doc.aliyuncs.com/assets/img/zh-CN/4297966571/p838707.png) **千问Max** 适合复杂任务，能力最强 | ![new](data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=) **千问Plus** 效果、速度、成本均衡 | ![new](data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=) **千问Flash** 适合简单任务，速度快、成本低 | ![new](data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=) **千问Coder** 卓越的代码模型，擅长工具调用和环境交互 |
| --- | --- | --- | --- | --- |
| 最大上下文长度 （Token数） | 262,144 | 1,000,000 | 1,000,000 | 1,000,000 |
| 最低输入价格 （每百万 Token） | 8.807元 | 2.936元 | 0.367元 | 2.202元 |
| 最低输出价格 （每百万 Token） | 44.035元 | 8.807元 | 2.936元 | 11.009元 |

## 国际

在[国际部署模式](https://help.aliyun.com/zh/model-studio/regions/#080da663a75xh)下，接入点与数据存储均位于**新加坡地域**，模型推理计算资源在全球范围内动态调度（不含中国内地）。

| **旗舰模型** | ![new](data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=) **千问Max** 适合复杂任务，能力最强 | ![new](data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=) **千问Plus** 效果、速度、成本均衡 | ![new](data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=) **千问Flash** 适合简单任务，速度快、成本低 | ![new](data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABCAQAAAC1HAwCAAAAC0lEQVR42mNkYAAAAAYAAjCB0C8AAAAASUVORK5CYII=) **千问Coder** 卓越的代码模型，擅长工具调用和环境交互 |
| --- | --- | --- | --- | --- |
| 最大上下文长度 （Token数） | 262,144 | 1,000,000 | 1,000,000 | 1,000,000 |
| 最低输入价格 （每百万 Token） | 8.807元 | 2.936元 | 0.367元 | 2.202元 |
| 最低输出价格 （每百万 Token） | 44.035元 | 8.807元 | 2.936元 | 11.009元 |
...
| --- | --- | --- | --- | --- | --- | --- |
| **（Token数）** |   |   | **（每百万Token）** |   |
| **qwen-mt-plus** > 属于[Qwen3-MT](https://modelscope.cn/studios/Qwen/Qwen3-MT-demo) | 16,384 | 8,192 | 8,192 | 1.8元 | 5.4元 | 各100万Token 有效期：百炼开通后90天内 |
| **qwen-mt-flash** > 属于[Qwen3-MT](https://modelscope.cn/studios/Qwen/Qwen3-MT-demo) | 0.7元 | 1.95元 |
| **qwen-mt-lite** > 属于[Qwen3-MT](https://modelscope.cn/studios/Qwen/Qwen3-MT-demo) | 0.6元 | 1.6元 |
| qwen-mt-turbo > 属于[Qwen3-MT](https://modelscope.cn/studios/Qwen/Qwen3-MT-demo) | 0.7元 | 1.95元 |
...
| --- | --- | --- | --- | --- | --- | --- |
| **（Token数）** |   |   | **（每百万Token）** |   |
| **qwen-mt-plus** > 属于[Qwen3-MT](https://modelscope.cn/studios/Qwen/Qwen3-MT-demo) | 16,384 | 8,192 | 8,192 | 1.8元 | 5.4元 | 无免费额度 |
| **qwen-mt-flash** > 属于[Qwen3-MT](https://modelscope.cn/studios/Qwen/Qwen3-MT-demo) | 0.7元 | 1.95元 |
| **qwen-mt-lite** > 属于[Qwen3-MT](https://modelscope.cn/studios/Qwen/Qwen3-MT-demo) | 0.6元 | 1.6元 |
...
| --- | --- | --- | --- | --- | --- | --- |
| **（Token数）** |   |   | **（每百万Token）** |   |
| **qwen-mt-plus** > 属于[Qwen3-MT](https://modelscope.cn/studios/Qwen/Qwen3-MT-demo) | 16,384 | 8,192 | 8,192 | 18.055元 | 54.09元 | 无免费额度 |
| **qwen-mt-flash** > 属于[Qwen3-MT](https://modelscope.cn/studios/Qwen/Qwen3-MT-demo) | 1.174元 | 3.596元 |
| **qwen-mt-lite** > 属于[Qwen3-MT](https://modelscope.cn/studios/Qwen/Qwen3-MT-demo) | 0.881元 | 2.642元 |
| qwen-mt-turbo > 属于[Qwen3-MT](https://modelscope.cn/studios/Qwen/Qwen3-MT-demo) | 1.174元 | 3.596元 |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| **（Token数）** |   |   |   | **（每百万 Token）** |   |
| deepseek-v3.2 > 685B 满血版 > [上下文缓存](https://help.aliyun.com/zh/model-studio/context-cache)享有折扣 | 131,072 | 98,304 | 32,768 | 65,536 | 2元  | 3元  | 各100万Token 有效期：百炼开通后90天内 |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
|     | **（Token数）** |   |   |   | **（每百万 Token）** |   |
| kimi-k2.5 | 思考模式 | 262,144 | 258,048 | 32,768 | 32,768 | 4元  | 21元 | 各100万Token 有效期：百炼开通后90天内 |
| 非思考模式 | 262,144 | 260,096 | \\- | 32,768 |
...
| --- | --- | --- | --- | --- | --- | --- |
| **（Token数）** |   |   | **（每百万 Token）** |   |
| MiniMax-M2.5 | 204,800 | 196,608 | 131,072 | 2.1 元 | 8.4元 | 100万Token 有效期：百炼开通后90天内 |
...
| --- | --- | --- | --- | --- | --- | --- |
| **（Token数）** |   |   | **每百万 Token** |   |     |
| MiniMax/MiniMax-M2.5 | 204,800 | 204,800 | 131,072 | 2.1元 | 8.4元 | 无   |
...
| tongyi-embedding-vision-plus | 1,152 | 图片/视频：0.5元 文本：0.5元 |
| tongyi-embedding-vision-flash | 768 | 图片/视频：0.15元 文本：0.15元 |
...
| --- | --- | --- | --- | --- | --- | --- |
| **（Token数）** |   |   | **（每百万 Token）** |   |
| gui-plus | 256,000 | 254,976 > 单图最大16384 | 32,768 | 1.5元 | 4.5元 | 100万Token 有效期：阿里云百炼开通后90天内 |
