...
| **管理员密码** | `<redacted-initial-password>` | 初始密码，首次登录强制修改 |
...
```
┌───────────────────────────────────────────────────────────────┐
│  🔒 StudySolo Admin                    admin@example.com   🔔 │
├────────────┬──────────────────────────────────────────────────┤
│            │                                                  │
│  📊 数据看板 │  ┌────────────────────────────────────────────┐ │
│            │  │                                            │ │
...
VALUES (
  '1037SoloAdmin',
  '$2b$12$...',   -- bcrypt hash of '<redacted-initial-password>'
  'admin@example.com',
  true            -- 首次登录强制修改密码
);
...
// Request
{
  ...
  "password": "<redacted-initial-password>"
}
